...
const TESTIMONIALS = [
	...
	},
	{
		name: 'Miranda',
		date: 'August 2024',
		text: 'We loved the apartment—spacious, clean, and felt like home. Perfect size for our family of four. Ideally located for seeing Valletta. My daughter wanted to move in forever!',
	},
	{
		name: 'Molly',
		date: 'August 2024',
